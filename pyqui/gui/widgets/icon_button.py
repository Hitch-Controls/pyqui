...
# https://doc.qtc.Qt.io/qtc.Qtforpython/licenses.html
#
# ///////////////////////////////////////////////////////////////
...
class PQIconButton(qtw.QPushButton):
    def __init__(
            self,
            icon_path=None,
            parent=None,
    ...
    def paintEvent(self, event):
        ...
        paint = qtg.QPainter()
        paint.begin(self)
        paint.setRenderHint(qtg.QPainter.RenderHint.Antialiasing)

        if self._is_active:
            # BRUSH
            brush = qtg.QBrush(qtg.QColor(self._context_color))
        else:
            # BRUSH
            brush = qtg.QBrush(qtg.QColor(self._set_bg_color))
    ...
    def move_tooltip(self):
        ...
        pos = self._app_parent.mapFromGlobal(gp)
