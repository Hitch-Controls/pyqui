...
class PQCreditsBar(qtw.QWidget):
    def __init__(
        self, copyright, version, bg_two, font_family, text_size, text_description_color, radius=8, padding=10
    ):
        super().__init__()
    ...
    def setup_ui(self):
        ...
        # SEPARATOR
        self.separator = qtw.QSpacerItem(20, 20, qtw.QSizePolicy.Expanding, qtw.QSizePolicy.Minimum)
