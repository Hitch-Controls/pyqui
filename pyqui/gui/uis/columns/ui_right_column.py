...
class Ui_RightColumn(object):
    ...
    def retranslateUi(self, RightColumn):
        RightColumn.setWindowTitle(qtc.QCoreApplication.translate("RightColumn", u"Form", None))
        self.label_1.setText(qtc.QCoreApplication.translate("RightColumn", u"Menu 1 - Right Menu", None))
        self.label_2.setText(qtc.QCoreApplication.translate("RightColumn", u"Menu 2 - Right Menu", None))
