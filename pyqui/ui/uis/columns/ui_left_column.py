...
class Ui_LeftColumn(object):
    ...
    def retranslateUi(self, LeftColumn):
        LeftColumn.setWindowTitle(qtc.QCoreApplication.translate("LeftColumn", u"Form", None))
        self.label_1.setText(qtc.QCoreApplication.translate("LeftColumn", u"Menu 1 - Left Menu", None))
        self.label_2.setText(qtc.QCoreApplication.translate("LeftColumn", u"Menu 2 - Left Menu", None))
